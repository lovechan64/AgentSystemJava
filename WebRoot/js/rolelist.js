$().ready(function(){
	...
	$("#addRoleBtn").click(function(){
		...
		if(roleName==''){
			...
			$.post("/editrole.action",{"type":add,"role.roleName":roleName, "role.isStart":isStart }
			,function(result){
				if(result=="peat"){
	...
	$("#modifyRoleSubmit").click(function(){
	 ...
	 var id=	$("#roleid").val();
		...
		if(roleName==''){
			...
			$.post("/editrole.action",{"type":type,"role.roleName":roleName, "role.isStart":isStart ,"role.id":id}
			,function(result){
	...
	$("#deleteRoleBtn").click(function(){
	 ...
	 var id=	$("#roleid").val();
			...
			$.post("/deleterole.action",{"role.id":id}
			,function(result){
